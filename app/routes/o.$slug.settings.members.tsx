          ...
          <p className="text-foreground/60">
            ...
            <Link to="../invitations" className="text-primary inline">
              <span className="font-bold">
                invite <CornerUpLeft strokeWidth={4} className="inline" size={14} />
              </span>
            </Link>{" "}
            them.
          </p>
            ...
            {members.data.map((member) => {
              return (
                <TableRow key={member.userEmail}>
                  ...
                  <TableCell>
                    <Chip color={member.role === Role.ADMIN ? "warning" : "default"}>
                  ...
                  <TableCell>
                    <Dropdown placement="top">
                      ...
                      <DropdownMenu
                        ...
                        onAction={(role) =>
                          submit({ role, userEmail: member.userEmail }, { method: "POST" })
                        }
                      >
                        {(item) => (
