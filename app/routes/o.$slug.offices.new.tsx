...
import { Link, useFetcher, useNavigate, ActionFunctionArgs, redirect } from "react-router"
...
export const action = async ({ request, params, context }: ActionFunctionArgs) => {
  ...
  if (intent === Intent.CHECK_AVAILABILITY) {
    const isAvailable = await core.office.isAvailable(name, profile.organizationSlug)
      ...
      <ModalContent>
        <Form method="POST">
          ...
          <ModalBody>
            ...
            <Input isClearable fullWidth isRequired name="spaceId" label="Space ID" />
          </ModalBody>
          <ModalFooter>
