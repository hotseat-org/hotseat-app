/*
  ...
  - You are about to alter the column `id` on the `Space` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `VarChar(36)`.
...
-- AlterTable
ALTER TABLE `Space` MODIFY `id` VARCHAR(36) NOT NULL,
